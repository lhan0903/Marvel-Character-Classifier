...
def classify_image(image_base64_data, file_path=None):
    ...
    for img in imgs:
        ...
        # returns the probability for face similarity to all avengers
        result.append({
            'class': class_number_to_name(__model.predict(final)[0]),
            'class_probability': np.around(__model.predict_proba(final)*100,2).tolist()[0],     # round to 2 decimal points
            'class_dictionary': __class_name_to_number                                          # for ui to display
        })
...
# ----------------------------------------
# RETURN: the name of the Avenger corresponding to the class number
...
# == Testing images with one person ==

    # print(classify_image(None, "server/test_images/tom.jpeg"))          # false prediction: robert
    # print("\n")
    # print(classify_image(None, "server/test_images/tom2.jpeg"))         # correct prediction
    # print("\n")
    # print(classify_image(None, "server/test_images/robert.png"))        # correct prediction
    # print("\n")
    # print(classify_image(None, "server/test_images/hemsworth.jpeg"))    # correct prediction


# == Testing image with two people ==

# predicted tom holland and chris hemsworth
    print(classify_image(None, "server/test_images/tom_and_zendaya.jpeg"))  
